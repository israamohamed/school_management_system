...
class StudentAttendanceController extends Controller
{
    ...
    public function index()
    {
        ...
        //$student_attendances = StudentAttendance::search()->paginate(25);
        /*$student_attendances = StudentAttendance::with('educational_class_room')->search()
                                                ->addSelectRaw('count(student_id) as attendants_numbr')
                                                ->paginate(25)
                                                ->groupBy('educational_class_room_id')*/
    ...
    public function create()
    {
        ...
        return view('dashboard.student_attendances.create' , compact('educational_stages' , 'class_rooms' , 'educational_class_rooms' , 'students' , 'absence_reasons'));
    }
    ...
    public function store(StudentAttendanceRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('dashboard.student_attendance.index')
