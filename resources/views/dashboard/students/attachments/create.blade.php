    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{route('dashboard.student.store_attachments' , $student->id)}}" method = "post" enctype="multipart/form-data">
                 @csrf
                 {{--name ar --}}
                 <div class="form-group">
                     <label for="attachments">{{__('general.attachments.one')}}</label>
