...
@section('title' , __('accounts.study_fees.create'))
...
@endpush
@section('breadcrumb')
    <h4 class="mb-sm-0">{{__('accounts.study_fees.create')}}</h4>
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">{{__('accounts.study_fees.create')}}</li>
        </ol>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title mb-3">
                    <h4 class = "float-start">{{__('accounts.study_fees.create')}}</h4>
                    <div class="clearfix"></div>
                </div>


                    <form action="{{route('dashboard.study_fee.store')}}" method = "post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "title_ar" class = "form-control @error('title_ar') is-invalid @enderror" value = "{{old('title_ar')}}" placeholder="{{__('general.title_ar')}}">
                                    @error('title_ar')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "title_en" class = "form-control @error('title_en') is-invalid @enderror" value = "{{old('title_en')}}" placeholder="{{__('general.title_en')}}">
                                    @error('title_en')
                                    <div class="invalid-feedback d-block">
                                        {{$message}}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "description_ar" class = "form-control @error('description_ar') is-invalid @enderror" value = "{{old('description_ar')}}" placeholder="{{__('general.description_ar')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "description_en" class = "form-control @error('description_en') is-invalid @enderror" value = "{{old('description_en')}}" placeholder="{{__('general.description_en')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="study_fee_item_id" class = "form-control select2 @error('study_fee_item_id') is-invalid @enderror">
                                        ...
                                        @foreach($study_fee_items as $study_fee_item)
                                            <option value="{{$study_fee_item->id}}" {{old('study_fee_item_id') == $study_fee_item->id ? 'selected' : ''}} >{{$study_fee_item->name}}</option>
                                        @endforeach       
                                    </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name = "amount" class = "form-control @error('amount') is-invalid @enderror" value = "{{old('amount')}}" placeholder="{{__('general.amount')}}">
                                    @error('amount')
                                    <div class="invalid-feedback d-block">
                                        {{$message}}
                                    </div>
