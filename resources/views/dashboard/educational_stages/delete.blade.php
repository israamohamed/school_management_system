   <!--primary theme Modal -->
   <div class="modal fade " id="delete_modal_{{$educational_stage->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.educational_stage.destroy' , $educational_stage)}}" 
                        method = "post" 
                        id = "delete_educational_stage{{$educational_stage->id}}">
                 @csrf
                 @method('delete')
