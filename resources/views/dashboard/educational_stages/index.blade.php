                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-bold-500">
                                        <button class = "btn btn-info" data-bs-toggle="modal" data-bs-target="#edit_modal_{{$educational_stage->id}}">{{__('general.edit')}}</button>
                                        <button class = "btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete_modal_{{$educational_stage->id}}">{{__('general.delete')}}</button>
