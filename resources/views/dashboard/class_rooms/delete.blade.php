   <!--primary theme Modal -->
   <div class="modal fade " id="delete_modal_{{$class_room->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.class_room.destroy' , $class_room)}}" 
                        method = "post" 
                        id = "delete_class_room{{$class_room->id}}">
                 @csrf
                 @method('delete')
