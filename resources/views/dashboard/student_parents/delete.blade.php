   <!--primary theme Modal -->
   <div class="modal fade " id="delete_modal_{{$student_parent->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.student_parent.destroy' , $student_parent)}}" 
                        method = "post" 
                        id = "delete_student_parent{{$student_parent->id}}">
                 @csrf
                 @method('delete')
