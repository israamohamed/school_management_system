...
@section('title' , __('general.subjects.edit'))
...
@endpush
@section('breadcrumb')
    <h4 class="mb-sm-0">{{__('general.subjects.edit')}}</h4>
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">{{__('general.subjects.edit')}}</li>
        </ol>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title mb-3">
                    <h4 class = "float-start">{{$subject->name}}</h4>
                    ...
                    <form action="{{route('dashboard.subject.update' , $subject->id)}}" method = "post">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "name_ar" class = "form-control @error('name_ar') is-invalid @enderror" value = "{{$subject->getTranslation('name' , 'ar')}}" placeholder="{{__('general.name_ar')}}">
                                    @error('name_ar')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "name_en" class = "form-control @error('name_en') is-invalid @enderror" value = "{{$subject->getTranslation('name' , 'en')}}" placeholder="{{__('general.name_en')}}">
                                    @error('name_en')
                                    <div class="invalid-feedback d-block">
                                        {{$message}}
                                    </div>
                                   ...
                                   <select name="educational_stage_id" class = "form-control educational_stage_selected select2  @error('educational_stage_id') is-invalid @enderror" style = "width: 100%;">
                                       <option value="">{{__('general.educational_stages.one')}}</option>
                                           @foreach($educational_stages as $educational_stage)
                                               <option value="{{$educational_stage->id}}" {{ $subject->class_room && $educational_stage->id == $subject->class_room->educational_stage_id ? 'selected' : ''}} >{{$educational_stage->name}}</option>
                                           @endforeach
                                   </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name = "upper_grade" class = "form-control @error('upper_grade') is-invalid @enderror" value = "{{$subject->upper_grade}}" placeholder="{{__('general.subjects.upper_grade')}}">
                                    @error('upper_grade')
                                    <div class="invalid-feedback d-block">
                                        {{$message}}
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name = "lower_grade" class = "form-control @error('lower_grade') is-invalid @enderror" value = "{{$subject->lower_grade}}" placeholder="{{__('general.subjects.lower_grade')}}">
                                    @error('lower_grade')
                                    <div class="invalid-feedback d-block">
                                        {{$message}}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name = "main_subject" class = "form-control form-check-input" id = "main_subject" {{$subject->main_subject ? 'checked' : ''}} >
                                </div>
                            </div>
                            {{-- success_required --}}
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name = "success_required" class = "form-control form-check-input" id = "success_required" {{$subject->success_required ? 'checked' : ''}} >
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name = "shared_between_terms" id = "shared_between_terms_checkbox" class = "form-control form-check-input" id = "shared_between_terms" {{$subject->shared_between_terms ? 'checked' : ''}} >
                                </div>
                            </div>

                            {{-- shared_between_terms --}}
                            <div class="col-md-3" id = "term_select_parent" style = "visibility :   {{$subject->shared_between_terms ? 'hidden' : 'visible' }} " >
                                <div class="form-group">
                                    ...
                                    <select name="term" id = "term_select" class = "form-control select2">
                                        ...
                                        <option value="first" {{$subject->term == 'first' ? 'selected' : ''}} >{{__('general.subjects.first_term')}}</option>
                                        <option value="second" {{$subject->term == 'second' ? 'selected' : ''}}>{{__('general.subjects.second_term')}}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name = "active" class = "form-check-input" id = "active" {{$subject->active ? 'checked' : ''}} >
                            </div>
                        </div>
...
@push('scripts')
@if($subject->class_room &&  $subject->class_room->educational_stage_id)
    <script>
        change_class_rooms($("select[name='educational_stage_id']") , "{{$subject->class_room_id}}"  );
    </script>
@endif
@endpush
