   <!--primary theme Modal -->
   <div class="modal fade " id="delete_modal_{{$absence_reason->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.absence_reason.destroy' , $absence_reason)}}" 
                        method = "post" 
                        id = "delete_absence_reason{{$absence_reason->id}}">
                 @csrf
                 @method('delete')
