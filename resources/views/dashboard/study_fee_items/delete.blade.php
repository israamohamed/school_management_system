   <!--primary theme Modal -->
   <div class="modal fade " id="delete_modal_{{$study_fee_item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.study_fee_item.destroy' , $study_fee_item)}}" 
                        method = "post" 
                        id = "delete_study_fee_item{{$study_fee_item->id}}">
                 @csrf
                 @method('delete')
