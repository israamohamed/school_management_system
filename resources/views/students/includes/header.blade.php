        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ auth()->guard('student')->user()->profile_picture }}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1">{{auth()->guard('student')->user()->name}}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    {{--template --}}
                    <a class="dropdown-item text-danger" href="{{ route('student.logout') }}" onclick="event.preventDefault();
