<div class="tab-pane active" id="upcoming_tab" role="tabpanel">
    <p class="mb-0">

      <div class = "my-2">

        <h4 class = "float-start">{{__('online_classes.upcoming_online_classes')}} <span class="badge rounded-pill bg-dark">{{$upcoming_online_classes->total()}}</span> </h4>

        <div class="clearfix"></div>
      </div>
     
        @if(count($upcoming_online_classes) > 0)
          <div class="table-responsive mb-2">
              <table class="table table-bordered mb-0">
                  ...
                  <tbody>
                      @foreach($upcoming_online_classes as $online_class)
                      <tr>        
                          ...
                          <td>
                              ...
                              @include('students.online_classes.join')
