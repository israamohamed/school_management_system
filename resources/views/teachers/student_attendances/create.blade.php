...
@section('breadcrumb')
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="{{route('teacher.student_attendance.index')}}">{{__('students.student_attendances.title')}}</a></li>
            ...
            <div class="card-body">
                ...
                @if(count($students) > 0)
                    ...
                    <div class="table-responsive m-2 border border-success" style = "">
                        ...
                        <form action="{{route('teacher.student_attendance.store')}}" method = "post">
                            @csrf
