...
@section('title' , __('quizzes.create'))

@push('styles')

@endpush
@section('breadcrumb')
    <h4 class="mb-sm-0">{{__('quizzes.create')}}</h4>
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">{{__('quizzes.create')}}</li>
        </ol>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title mb-3">
                    <h4 class = "float-start">{{__('quizzes.create')}}</h4>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "name" class = "form-control @error('name') is-invalid @enderror" value = "{{old('name')}}" placeholder="{{__('quizzes.name')}}">
                                    @error('name')
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "time_in_minutes" class = "form-control @error('time_in_minutes') is-invalid @enderror" value = "{{old('time_in_minutes')}}" placeholder="{{__('quizzes.time_in_minutes')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class = "form-control select2">
                                        <option value="pending" {{old('status') == 'pending' ? 'selected' : ''}} >{{__('quizzes.pending')}}</option>
                                        <option value="started" {{old('status') == 'started' ? 'selected' : ''}} >{{__('quizzes.started')}}</option>
                                        <option value="finished" {{old('status') == 'finished' ? 'selected' : ''}} >{{__('quizzes.finished')}}</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="subject_id" class = "form-control select2 @error('subject_id') is-invalid @enderror" placeholder = "{{__('general.subjects.select')}}">
                                        ...
                                        @foreach($subjects as $subject )
                                            <option value="{{$subject->id}}" {{old('subject_id') == $subject->id ? 'selected' : '' }}  >{{$subject->name_in_details}}</option>
                                        @endforeach
                                    </select>
                                    @error('subject_id')
                                    <div class="invalid-feedback d-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="educational_class_room_id" class = "form-control select2 @error('educational_class_room_id') is-invalid @enderror" placeholder = "{{__('general.educational_class_rooms.select')}}">
                                        ...
                                        @foreach($educational_class_rooms as $educational_class_room )
                                            <option value="{{$educational_class_room->id}}" {{old('educational_class_room_id') == $educational_class_room->id ? 'selected' : '' }}  >{{$educational_class_room->name}}</option>
                                        @endforeach
                                    </select>
