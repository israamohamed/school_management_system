    ...
    <div class="wrapper-page">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h3 class="text-center mt-0 mb-3">
                    <a href="#"><img src="{{asset('images/teacher.png')}}" style = "width: 40%;"></a>
                </h3>



                <h5 class="text-center mt-0 text-color"><b>Teacher Sign In</b></h5>

                <form method="POST" action="{{ route('teacher.login') }}" class="form-horizontal mt-3 mx-3">
                    @csrf
