   <!--primary theme Modal -->
   <div class="modal fade " id="delete_modal_{{$online_class->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('teacher.online_class.destroy' , $online_class->id)}}" 
                        method = "post" >
                 @csrf
                 @method('delete')
