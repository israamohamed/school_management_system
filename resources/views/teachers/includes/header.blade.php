        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{route('dashboard.home')}}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{asset('dashboard/assets/images/logo-light.png')}}" alt="logo-light" height="24">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        ...
                        <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" hreflang="{{ $localeCode }}" class="dropdown-item notify-item">
                            <img src="{{asset('dashboard/assets/images/flags/' . $properties['flag'] )}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">{{ $properties['native'] }}</span>
                        </a>
                    @endforeach
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ auth()->guard('teacher')->user()->profile_picture }}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1">{{auth()->guard('teacher')->user()->name}}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    {{--template --}}
                    <a class="dropdown-item text-danger" href="{{ route('teacher.logout') }}" onclick="event.preventDefault();
